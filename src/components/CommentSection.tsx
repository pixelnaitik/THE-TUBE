      ...
      <div className="flex-1">
        ...
        {!isReply && session && (
          <button
            ...
            className="text-xs text-gray-400 hover:text-blue-400 mt-1 font-medium"
          >
            Reply
          </button>
        )}
      ...
      <div className="flex flex-col gap-4">
        {comments.map(comment => (
          <div key={comment.id}>
            ...
            {/* Reply form */}
            {replyTo === comment.id && (
              <form onSubmit={(e) => handleSubmit(e, comment.id)} className="ml-12 mt-2 flex gap-2">
                <input
            ...
            {comment.replies && comment.replies.length > 0 && (
              <>
                <button
                  ...
                  className="ml-12 mt-2 text-xs text-blue-400 hover:text-blue-300 font-medium flex items-center gap-1"
                >
